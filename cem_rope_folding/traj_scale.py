...
def get_picked_point(action):
    ...
    key_point_index = np.array([0, 16, 24, 40]) 
...
def main():
    ...
    parser.add_argument('--env_name', default='RopeConfiguration') #RopeConfiguration RopeFlatten ClothFold
    ...
    parser.add_argument('--get_initial_image', default=True, type=bool)
    parser.add_argument('--get_folded_data', default=True, type=bool)

    # 20220828114814 4 36
    # 20220829220627 8 16
    # 'data/cem/original/20220827001019/traj/action_traj_1.npy'
    # 'data/cem/simple/20220826214525/traj/action_traj_1.npy'
    # 25 8 hand_crafted
    path_to_action = 'data/cem/hand_crafted/20220902161752/traj/action_traj_1.npy'
    ...
    parser.add_argument('--env_kwargs_horizon', default=20, type=int) #15
