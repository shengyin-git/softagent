...
def main():
    ...
    parser.add_argument('--env_name', default='RopeFold') #RopeConfiguration RopeFlatten
    ...
    key_point_idx = get_rand_int(low=0, high=40, size=4)#np.random.randint(low=0, high=40, size=4)#
