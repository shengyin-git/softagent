...
for i in range(m):
    j = i + 1
    temp_name = osp.join(current_path, '../data/cem/original/20220901164544/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/simple/20220901152154/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    # 20230124142247 20230123171739
    temp_name = osp.join(current_path, '../data/cem/random/20230124142247/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/hand_crafted/20220902121741/data/reward_his_' + str(j) +'.npy')
