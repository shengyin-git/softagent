...
for i in range(m):
    j = i + 1
    temp_name = osp.join(current_path, '../data/cem/original/20220903214151/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/simple/20220902224547/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/random/cem/20230201150214/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/hand_crafted/20220903110938/data/reward_his_' + str(j) +'.npy')
