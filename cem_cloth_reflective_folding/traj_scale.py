...
def get_picked_point(action):
    ...
    # key_point_index = np.array([0, 24, 49, 99, 9902, 9924, 9947, 9997]) 
...
def run_task(vv, log_dir, exp_name):
    ...
    for k in range(num_actions_):
        current_action_ = action_seq_[k]
        obs_, reward_, _, info_ = env.step(current_action_)
...
def main():
    ...
    # # data/cem/simple/20220826222635/traj/action_traj_1.npy
    # 20220827215749 4 24
    # 20220826222635 8 8
    path_to_action = 'data/cem/simple/20220922205103/traj/action_traj_7.npy' # 7
