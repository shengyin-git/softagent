...
for i in range(m):
    j = i + 1
    temp_name = osp.join(current_path, '../data/cem/original/20220902221347/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/simple/20220901215730/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/random/cem/20230204185229/data/cost_his_' + str(j) +'.npy')
...
for i in range(m):
    j = i +1
    temp_name = osp.join(current_path, '../data/cem/hand_crafted/20220903102923/data/reward_his_' + str(j) +'.npy')
